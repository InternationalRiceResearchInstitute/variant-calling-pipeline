...
for line in open(params.fp):
    if re.findall(r'scripts_dir=', line): params.scripts_dir = line.split('=')[-1].rstrip()
    elif re.findall(r'reference_dir=', line): params.reference_dir = line.split('=')[-1].rstrip()
    elif re.findall(r'bwa=', line): params.bwa = line.split('=')[-1].rstrip()
...
if fasta in params.reference_dir: params.reference_dir = params.reference_dir.replace(fasta, params.regex)
