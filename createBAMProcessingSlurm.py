...
for line in open(params.fp):
    if re.findall(r'jvm=', line): params.jvm = line.split('=')[-1].rstrip()
    elif re.findall(r'gatk=', line): params.gatk = line.split('=')[-1].rstrip()
    ...
    elif re.findall(r'picard=', line): params.picard = line.split('=')[-1].rstrip()
    elif re.findall(r'partition=', line): params.partition = line.split('=')[-1].rstrip()
    elif re.findall(r'cpu_sambam=', line): params.cpu_sambam = line.split('=')[-1].rstrip()
