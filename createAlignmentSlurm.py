...
for line in open(params.fp):
    if re.findall(r'bwa=', line): params.bwa = line.split('=')[-1].rstrip()
    ...
    elif re.findall(r'cpu_fqsam=', line): params.cpu_fqsam = line.split('=')[-1].rstrip()
...
for line in open(input_file):
    ...
    fqsam.write("#SBATCH -c " + params.cpu_fqsam + "\n")
